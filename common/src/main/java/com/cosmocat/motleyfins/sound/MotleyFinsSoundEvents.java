...
public class MotleyFinsSoundEvents {
    ...
    public static SoundEvent registerSound(String name) {
        ResourceKey<@NotNull SoundEvent> key = ResourceKey.create(Registries.SOUND_EVENT, ResourceLocation.fromNamespaceAndPath(MotleyFins.MOD_ID, name));
        SoundEvent soundEvent = SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(MotleyFins.MOD_ID, name));
