...
public class MotleyFinsFabric implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        BiomeModifications.addSpawn(BiomeSelectors.tag(MotleyFinsTags.Biomes.SPAWNS_PARROTFISH), MobCategory.WATER_AMBIENT, MotleyFinsEntities.PARROTFISH, 25, 6, 8);
    ...
    private static void addItemsToCreativeTabs() {
        ...
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.SPAWN_EGGS).register((entries) -> entries.addAfter(Items.PARROT_SPAWN_EGG, MotleyFinsItems.PARROTFISH_SPAWN_EGG));
    }
}