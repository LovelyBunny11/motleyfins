...
public class MotleyFinsNeoforge {
    ...
    public static final DeferredRegister<@NotNull EntityType<?>> ENTITY_TYPES = DeferredRegister.create(Registries.ENTITY_TYPE, MotleyFins.MOD_ID);
    ...
    public static final DeferredRegister<@NotNull SoundEvent> SOUND_EVENTS = DeferredRegister.create(Registries.SOUND_EVENT, MotleyFins.MOD_ID);
