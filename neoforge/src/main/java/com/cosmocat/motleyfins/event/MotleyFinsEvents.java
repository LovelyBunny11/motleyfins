...
public class MotleyFinsEvents {
    ...
    public static void buildContents(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS) {
            ...
            event.insertAfter(Items.PARROT_SPAWN_EGG.getDefaultInstance(), MotleyFinsItems.PARROTFISH_SPAWN_EGG.asItem().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        }
    }
}
